...
function draw(){
    ...
    if(scoreleftWrist > 0.2){
        ...
        if(song_Peter_pan == false){
            ...
            console.log("Song Name: No Lie (Feat.Dua Lipa)");
            document.getElementById("song_id").innerHTML = "Song Name: No Lie (Feat.Dua Lipa)";
        }
    }
    ...
    if(scorerightWrist > 0.2){
        ...
        if(song_Harry_potter_theme == false){
            ...
            console.log("Song Name: Alone Pt-II");
            document.getElementById("song_id").innerHTML = "Song Name: Alone Pt-II";
        }
    }
}
